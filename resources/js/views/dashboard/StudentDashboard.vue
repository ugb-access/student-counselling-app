...
const { readonly, data, type } = toRefs(props);
...
const fetchStudentDetail = () => {
    ...
    getStudentDetail(id)
        .then((res) => {
            ...
            if (response.data) {
                photo_path.value.preview = response.data.student.photo_path;
                full_name.value = response.data.student.full_name;
                email.value = response.data.student.email;
                nationality.value = response.data.student.nationality;
                marital_status.value =
                    response.data.student.marital_status.toString();
                gender.value = response.data.student.gender.toString();
                date_of_birth.value = response.data.student.date_of_birth;
                place_of_birth.value = response.data.student.place_of_birth;
                passport_no.value = response.data.student.passport_no;
                expiry_date.value = response.data.student.expiry_date;
                place_of_issue.value = response.data.student.place_of_issue;
                address.value = response.data.student.address;
                phone.value = response.data.student.phone;
                mobile.value = response.data.student.mobile;
                mobile_2.value = response.data.student.mobile_2;
                referee_name.value = response.data.student.referee_name;
                referee_mobile.value = response.data.student.referee_mobile;
                document_correction.value =
                    response.data.student.document_correction;

                education_history.value =
                    response.data.student.education_history;

                semester_year.value =
                    response.data.student.semester_year.toString();

                country_detail.value = response.data.student.country_detail;

                cv_path.value = response.data.student.cv_path;
                passport.value = response.data.student.passport;
                academic_document.value =
                    response.data.student.academic_document;
                teacher_reference.value =
                    response.data.student.teacher_reference;
                cnic.value = response.data.student.cnic;
                experience_letter.value =
                    response.data.student.experience_letter;
                other_certificates.value =
                    response.data.student.other_certificates;
                conditional_offer.value =
                    response.data.student.conditional_offer;
                unconditional_offer.value =
                    response.data.student.unconditional_offer;
                payment_proof.value = response.data.student.payment_proof;
                cas_ecoe.value = response.data.student.cas_ecoe;
                visa.value = response.data.student.visa;
                travel_plan.value = response.data.student.travel_plan;
                gt_document.value = response.data.student.gt_document;

                moi.value = response.data.student.english_test?.moi;
                english_proficiency.value =
                    response.data.student.english_test?.english_proficiency;
                ielts.value = response.data.student.english_test?.ielts;
                other_english_test.value =
                    response.data.student.english_test?.other_english_test;
            }
        })
        .catch((err) => {});
};
