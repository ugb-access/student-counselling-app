...
const father_number = ref(null);
const mother_name = ref(null);
const mother_number = ref(null);
...
const handleSubmit = (e) => {
	if (edit.value) {
		...
		const data = {
			...
			father_number: father_number.value,
			mother_name: mother_name.value,
			mother_number: mother_number.value,
		};
...
const fetchStudentDetail = () => {
	if (data.value) {
		...
		father_name.value = data.value.student.father_name;
		father_number.value = data.value.student.father_number;
		mother_name.value = data.value.student.mother_name;
		mother_number.value = data.value.student.mother_number;
	}
};
