...
<head>
  ...
  <title>Royal Vision Education Counseling | The Race for Excellence Has No Finish Line</title>
...
<body>
  <div id="app">
    <div id="loading-bg">
      <div class="loading-logo">
        ...
        <img src="{{ asset('logo.png') }}" style="height: 50px; margin-left: 12px; margin-bottom: 20px;" />
      </div>
      <div class="loading">
  ...
  <script>
    ...
    const primaryColor = localStorage.getItem('materio-initial-loader-color') || '#ff0037'
