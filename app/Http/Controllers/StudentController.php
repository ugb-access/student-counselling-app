...
class StudentController extends Controller
{
    ...
    public function store_student_detail(Request $request) {
        ...
        $validator = Validator::make($data, [
            ...
            'cv_path' => 'nullable',
            'passport' => 'nullable', 
            'english_test.*' => 'nullable',
            'academic_document' => 'nullable',
            'teacher_reference' => 'nullable',
            'cnic' => 'nullable',
            'experience_letter' => 'nullable',
            'other_certificates' => 'nullable', 
            'conditional_offer' => 'nullable',
            'unconditional_offer' => 'nullable',
            'payment_proof' => 'nullable',
            'cas_ecoe' => 'nullable',
            'visa' => 'nullable',
            'travel_plan' => 'nullable',
            'gt_document' => 'nullable',
